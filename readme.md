...
| [Svelte](https://svelte.dev/) | [❌](https://svelte.dev/docs/introduction) | [❌](https://svelte.dev/docs/introduction) | [❌](https://svelte.dev/docs/introduction) | ❌ | ❌ | ❌ | [⚠️](https://svelte.dev/docs/svelte/svelte-components#script-module-context) |
