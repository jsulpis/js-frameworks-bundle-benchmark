...
| Framework | [SSG](https://en.wikipedia.org/wiki/Static_site_generator) | [SSR](https://en.wikipedia.org/wiki/Server-side_scripting) | Streaming SSR | API Routes | Server Actions | File-based Routing | [Code Splitting](https://developer.mozilla.org/en-US/docs/Glossary/Code_splitting) |
|-----------|-----|-----|---------------|------------|----------------|-------------------|---------------|
...
| [React 19](https://react.dev/) | [❌](https://react.dev/learn) | [❌](https://react.dev/learn) | [❌](https://react.dev/learn) | ❌ | ❌ | ❌ | [⚠️](https://react.dev/reference/react/lazy) |
